...
def setup(request):
    ...
    ''' here we are assigning local "driver" to Class "driver" by using "request instance" 
       we defined as class variable so we can access by self.driver in test case file'''
